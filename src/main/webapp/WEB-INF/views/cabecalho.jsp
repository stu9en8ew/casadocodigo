...
<!-- Import da taglib fmt para uso do recurso de internacionalização -->
<%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
  ...
  <header id="layout-header">
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						...
						<!-- Acréscimo de opções de menu para tradução do site -->
	...
	<nav class="categories-nav">
		<ul class="container">
			<!-- Uso da taglib fmt com a propriedade message e atributo key para passar a chave contida no messages.properties-->
